        ...
        $tasks = [
            ...
            [
                ...
                'content' => '<p>Перехвачены параметры асимметричного шифрования:</p>'
                    ...
                    . '</ul>'
                    . '<p>Каждый блок — один символ (числовой код ASCII). В таблице есть лишние тестовые блоки.</p>'
                    . '<p>Расшифруйте все блоки. В тело флага войдут только <strong>строчные латинские буквы a–z</strong>, в порядке номеров блоков.</p>'
                    . '<table class="table table-sm table-bordered mb-3">'
                    . '<thead><tr><th>Блок</th><th>Шифротекст c</th></tr></thead>'
                    . '<tbody>'
                    . '<tr><td>1</td><td>2412</td></tr>'
                    . '<tr><td>2</td><td>1345</td></tr>'
                    . '<tr><td>3</td><td>1230</td></tr>'
                    . '<tr><td>4</td><td>2557</td></tr>'
                    . '<tr><td>5</td><td>1632</td></tr>'
                    . '</tbody></table>'
